...
* **永久免费使用。** 我们有开源项目二三十个，热衷于开源事业，此项目本身初衷是为了[网市场云建站系统（SAAS CMS）](https://gitee.com/mail_osc/wangmarket) 而配套的，给网站做多语言支持的，您无需担心收费问题！当然如果您项目比较大，日访问量到了百万级千万级的，我们建议您私有化部署。
...
````
建议都放在 translate.execute() 这行之前。不过就算放在之后也没关系的。
