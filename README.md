...
## 能做什么
* 网页中加入两行JS，其他的啥都不用管，就能让你原本网页支持上百语种切换
    * 原本是中文、英文 ... 的网站，支持百个语种切换
    * 传统i18n国际化还要挨个自己写，后续系统升级很容易漏掉某些对应翻译，没技术含量但极大消耗技术投入！摆脱传统i18n，拥抱AI加持的 translate.js 新时代AI能力的i18n吧，引入js就可以了，别的就没你什么事了。VUE、React、Layui、Jquery ... 针对所有框架都完美兼容支持。
    * 管理后台的语种切换，又或者是开源管理后台框架，直接植入本能力，后续你就可以完全不用考虑国际化这块了，它全包了，还是全自动的
    * 一体机设备及无网络环境使用，translate.js 可以直接导出离线的翻译语句对应配置
