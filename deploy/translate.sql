...
CREATE TABLE `translate_site_set` (
  ...
  `execute_js` mediumtext COLLATE utf8mb4_unicode_ci COMMENT '对应的js设置。在执行页面翻译的操作时，额外执行的js。这个只是在翻译的过程中进行执行，影响的是输出的翻译结果html。它本身并不会追加到输出的html上',
  `html_append_js` mediumtext COLLATE utf8mb4_unicode_ci COMMENT '翻译完成后，在html页面中追加的js。 这个会在html最末尾追加',
  PRIMARY KEY (`id`)
