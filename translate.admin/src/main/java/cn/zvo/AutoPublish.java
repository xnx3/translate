...
public class AutoPublish extends com.xnx3.autoPublish.AutoPublish{
	...
	public static void main(String[] args) {
		...
		/***** 服务器账号密码 *****/
		SERVER_HOST = "190.92.219.190";  //服务器ip
		SERVER_USERNAME = "root";		 //服务器ssh登录账号
		SERVER_PASSWORD = "Leimingyun!23";//服务器ssh登录密码
		
		//不杀死所有结束java进程
		SHELL_KILL_JAVA = null;
		//设置启动关闭tomcat
		SHELL_SHUTDOWN_TOMCAT = "/mnt/admin/bin/shutdown.sh";
		SHELL_START_TOMCAT = "/mnt/admin/bin/startup.sh";
		//设置应用所在
		WEBAPPS_PATH = "/mnt/admin/webapps/ROOT";
